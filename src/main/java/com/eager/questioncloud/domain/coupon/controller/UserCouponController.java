package com.eager.questioncloud.domain.coupon.controller;

import com.eager.questioncloud.common.DefaultResponse;
import com.eager.questioncloud.domain.coupon.dto.Response.GetAvailableUserCouponsResponse;
import com.eager.questioncloud.domain.coupon.dto.UserCouponDto.AvailableUserCouponItem;
import com.eager.questioncloud.domain.coupon.service.UserCouponService;
import com.eager.questioncloud.domain.coupon.dto.Request;
...
public class UserCouponController {
    ...
    public DefaultResponse registerCoupon(@AuthenticationPrincipal UserPrincipal userPrincipal, @RequestBody @Valid Request.RegisterCouponRequest request) {
