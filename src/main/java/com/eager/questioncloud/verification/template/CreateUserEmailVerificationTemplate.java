...
@Getter
public class CreateUserEmailVerificationTemplate extends EmailVerificationTemplate {
    String title = "[QuestionCloud] 회원가입 인증 메일";
    String content;

    public CreateUserEmailVerificationTemplate(String token) {
        super();
        this.content = """
            <!DOCTYPE html>
            <html lang="ko">
