package com.eager.questioncloud.api.review.controller

import com.eager.questioncloud.api.review.dto.ModifyQuestionReviewRequest
import com.eager.questioncloud.api.review.dto.MyQuestionReviewResponse
import com.eager.questioncloud.api.review.dto.RegisterQuestionReviewRequest
import com.eager.questioncloud.api.review.service.StoreReviewService
...
class StoreReviewController(
    ...
    fun modifyQuestionReview(
        ...
        storeReviewService.modify(reviewId, userPrincipal.userId, request.comment, request.rate)
        return DefaultResponse.success()
    }
    ...
    fun deleteQuestionReview(
        ...
        storeReviewService.delete(reviewId, userPrincipal.userId)
        return DefaultResponse.success()
    }
}
