...
import com.eager.questioncloud.core.domain.coupon.infrastructure.entity.QUserCouponEntity.userCouponEntity
import com.eager.questioncloud.core.domain.coupon.infrastructure.entity.UserCouponEntity.Companion.from
...
class UserCouponRepositoryImpl(
    ...
    override fun save(userCoupon: UserCoupon): UserCoupon {
        return userCouponJpaRepository.save(from(userCoupon)).toModel()
    }
