...
@WebMvcTest(
    controllers = [StoreProductController::class],
    excludeFilters = [
                ...
                document(
                    ...
                    snippets = arrayOf(
                        ...
                        responseFields(
                            ...
                            fieldWithPath("result[].questionContent.description").description("문제 설명"),
                ...
                document(
                    ...
                    snippets = arrayOf(
                        ...
                        responseFields(
                            ...
                            fieldWithPath("productDetail.questionContent.description").description("문제 설명"),
