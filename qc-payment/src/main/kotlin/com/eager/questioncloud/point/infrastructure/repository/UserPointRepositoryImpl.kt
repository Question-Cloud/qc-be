...
import com.eager.questioncloud.point.infrastructure.entity.QUserPointEntity.userPointEntity
...
class UserPointRepositoryImpl(
    ...
    override fun save(userPoint: UserPoint): UserPoint {
        return userPointJpaRepository.save(UserPointEntity.createNewEntity(userPoint)).toModel()
    }
